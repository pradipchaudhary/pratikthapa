  ...
  return (
    <main className="bg-gray-50 min-h-screen text-gray-800">
        <section className="text-center py-10 bg-gray-900 text-white">
          ...
          <p className="text-lg mt-2">Trans Rights Activist | Banking & Finance | Admin | HR</p>
          <a
        ...
        <section className="max-w-4xl mx-auto px-4 py-12">
          ...
          <p>
            🔗 <a href="https://www.linkedin.com/in/pratiik-thapa-502876205" className="text-blue-600 underline">LinkedIn</a>
          </p>
